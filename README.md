...
1. uart converter rx -> arduino uno r3 rx
2. uart converter tx -> arduino uno r3 tx
3. arduino uno r3 reset -> arduino uno r3 gnd
...
1. uart converter usb -> PC
2. arduino usb -> switch
...
## Credit
Great thanks to [wchill](https://github.com/wchill/SwitchInputEmulator), I learnt my encoding part from this repo.
